...
namespace MovieNetWPF.WCFNoteService {
    ...
    public interface INoteService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INoteService/FindNotesOfUser", ReplyAction="http://tempuri.org/INoteService/FindNotesOfUserResponse")]
        MovieNetWPF.WCFNoteService.Note[] FindNotesOfUser(int idUser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/INoteService/FindNotesOfUser", ReplyAction="http://tempuri.org/INoteService/FindNotesOfUserResponse")]
        System.Threading.Tasks.Task<MovieNetWPF.WCFNoteService.Note[]> FindNotesOfUserAsync(int idUser);
    }
    ...
    public partial class NoteServiceClient : System.ServiceModel.ClientBase<MovieNetWPF.WCFNoteService.INoteService>, MovieNetWPF.WCFNoteService.INoteService {
        ...
        public MovieNetWPF.WCFNoteService.Note[] FindNotesOfUser(int idUser) {
            return base.Channel.FindNotesOfUser(idUser);
        }
        
        public System.Threading.Tasks.Task<MovieNetWPF.WCFNoteService.Note[]> FindNotesOfUserAsync(int idUser) {
